...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{Figures/loglog}
	\caption[Link weight fit]{\textbf{Link weight fit}}
	\label{fig:123edgeslog}
\end{figure}
...
\begin{figure}[htb]
	...
	\begin{subfigure}[b]{1.0\textwidth}
		...
		\vspace*{5mm}
	\end{subfigure}
	\caption[Communities per network for WT]{\textbf{Communities per network for WT} The \emph{green} colour represents the younger community, containing the queen. The \emph{orange} color represents the older community. The \emph{gray} represents the middle-age community. The hive exit on side A is on the bottom right and on side B on the bottom left. The data is aggredated for the complete timeframe of ten hours.}
...
\begin{figure}
	...
	\caption[Snapshot 3: Scatter plot for node level measure]{\textbf{Snapshot 3: Scatter plot for node level measure}}
