...
Automatic tracking data has been used to investigate ant colonies~\cite{mersch2013tracking} using network analysis methods.
\textcite{mersch2013tracking} used a dataset, obtained by long term observation of six ant colonies including all individuals, to investigate temporal aspects of the ants' social network.
Their study was able to provide new insights into the dynamics of the colonies' functinal units.

Applying network analysis methods to the automatic tracking data of honey bees and the resulting possibility to investigate temporal aspects of the social network holds the potential of new scientific knowledge in the area of behavioral sciences.
My work lays the foundation to follow this new path of research.
