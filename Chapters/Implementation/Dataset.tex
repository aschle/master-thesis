...
\begin{figure}[htb]
	...
	\caption[Detection frequency of IDs]{\textbf{Detection frequency of IDs} [TODO: add legend to image: green - IDs with a positive age, yellow - IDs with a negative age] Data set: 24 hours 20.08.2016, total frames = 302400}
	\label{fig:filter}
\end{figure}
...
I excluded IDs (in advance) with a negative age but a detection frequency over 10000 and bees, as they seem to be real bees, when looking at the videos (probably mistakes in hatching day table).
IDs who definately exists, but their age can to be determinded are also excluded from the analysis completely. These are bees, who were tagged a long time after hatching~($n=10$)\footnote{id= [2,
	74,
	2045,
	3172,
	3764,
...
Additionally, I discarded all detections with an ID frequency below percentil 99, calculated for only the negative ID distribution.
A list with valid IDs per day is kept to filter out wrong detection beforehand.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
For further analysis I use data of the following days: 20.08.2016, 22.08.2016, 24.08.2016. The confidence level is set to 95\%.
